...
public class dashboardController implements Initializable {
    ...
    if (event.getSource() == home_btn) {
        ...
        home_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #0099cc, #0066cc)"); // ubah warna gradient menjadi biru benhur
        ...
        availableFlowers_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #0099cc, #0066cc)"); // ubah warna gradient menjadi biru benhur
        ...
        purchase_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #0099cc, #0066cc)"); // ubah warna gradient menjadi biru benhur
        availableFlowers_btn.setStyle("-fx-background-color: transparent");
        home_btn.setStyle("-fx-background-color: transparent");
